...
<body>
    ...
    //                      要改的時間                 要改的日期 
    //                          ↓                         ↓
    // UPDATE `schedule` SET `0800`=null WHERE `date`='2019-11-23'
    ...
    if (isset($_POST["index"])) {
        ...
        // 取得修改資料庫的語句
        $sql_cmd = "UPDATE `schedule` SET $fix_time=null WHERE `date`='$fix_date'";
        $_SESSION["target"] = "UPDATE `schedule` SET $fix_time=null WHERE `date`='$fix_date'";
        // echo $sql_cmd;
    } else {
        echo "fail";
    }
    ...
    <table border="1" align="center">
        ...
        <tr align="center">
            ...
            <td><?php
                $d_cmd = "SELECT `$fix_time` FROM `schedule` WHERE `date`='$fix_date';";
