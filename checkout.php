    ...
    <header class="header">
      ...
      <ul class="menu">
        ...
        <?php } elseif ($_SESSION["loginMember"] == "admin") {
          echo "<li><a href='admin_add.php'>管理公告</a></li>" . "<li><a href='member_admin.php'>系統管理</a></li>" . "<li><a href='?logout=true'>Sign out&nbsp[" . $_SESSION["loginMember"] . "]</a></li>";
        } else {
                  ...
                  <tr valign="top">
                    <td width="200" class="tdrline">
                      ...
                      <div class="categorybox">
                        <p class="heading">廚房場地搜尋 <span class="smalltext"></span></p>
                        ...
                        <p class="heading">價格區間 <span class="smalltext"></span></p>
                      ...
                      <div class="boxbr"></div>
                      <div class="categorybox">
                        <p class="heading">廚房縣市分類 <span class="smalltext"></span></p>
                        <ul>
                      ...
                      <div class="normalDiv">
                        <?php if ($cart->itemcount > 0) { ?>
                          ...
                          <table width="90%" border="0" align="left" cellpadding="2" cellspacing="1">
                            ...
                            <tr>
                              <td align="center" valign="baseline" bgcolor="#F6F6F6">
                                <p>總計</p>
                              </td>
                              <td valign="baseline" bgcolor="#F6F6F6">
                                <p>&nbsp;</p>
                              </td>
                              <td align="center" valign="baseline" bgcolor="#F6F6F6">
                                <p>&nbsp;</p>
                              ...
                              <td align="center" valign="baseline" bgcolor="#F6F6F6">
                                <p class="redword">$ <?php echo number_format($cart->grandtotal); ?></p>
                              </td>
                            </tr>
                          </table><br></br>
                          <br>
