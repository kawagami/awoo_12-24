...
//未加限制顯示筆數的SQL敘述句
$query_RecKitchen = "SELECT * FROM `kitchen_data` LEFT JOIN `kitchen_photo` USING (kit_id) WHERE m_id='{$mid}' GROUP BY kit_id ";
...
<html>
	...
	<div class="id_wrapper">
		...
		<div class="id_content">
          ...
          <tr><td align="center"><h1><?php echo $_SESSION["loginMember"];?>的廚房列表</h1></td></tr>        
