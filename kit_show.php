				...
				<div class="kit_show">
					...
					<div class="kit_info">
						<div class="kit_location">
							...
							<p><img src="images/location.png" width=30px;><?php echo $row_RecKitchen["kit_county"]; ?> <?php echo $row_RecKitchen["kit_city"]; ?></p>
							<p><img src="images/owner.png" width=30px;><?php echo $row_RecKitchen["m_username"]; ?></p>								
						</div>
						...
						<div class="kit_dese">
							...
							<p><span class="smalltext">地圖：</span></p>
                                <iframe width='100%' height='100%' frameborder='0' scrolling='no' marginheight='0' marginwidth='0' src="https://maps.google.com.tw/maps?f=q&hl=zh-TW&geocode=&q=高雄市'<?php echo $row_RecKitchen["kit_city"];?><?php echo $row_RecKitchen["kit_add"];?>'&z=16&output=embed&t=">
                                    </iframe>
						</div>
		                        <div>
                                    <p>租借時間：</p>
