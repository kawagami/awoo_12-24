...
<body style="font-family: Microsoft JhengHei;">
	<div class="id_wrapper">
		<header class="header">
			...
			<?php } elseif ($_SESSION["loginMember"] == "admin") {
				echo '<a href="member_admin.php" class="logo" style="text-decoration:none;color:#fff;">來吃飯</a>';
			} else {
				echo '<a href="index2.php" class="logo" style="text-decoration:none;color:#fff;">來吃飯</a>';
			} ?></a>
			...
			<ul class="menu">
				...
				<?php if (!isset($_SESSION["loginMember"]) || ($_SESSION["loginMember"] == "")) { ?>
					...
					<!--這段更改--><a href="member_admin.php"><?php } elseif ($_SESSION["loginMember"] == "admin") {
															echo "<li><a href='admin_add.php'>管理公告</a></li>" . "<li><a href='member_admin.php'>系統管理</a></li>" . "<li><a href='order_admin.php'>訂單查詢</a></li>" . "<li><a href='?logout=true'>Sign out&nbsp[" . $_SESSION["loginMember"] . "]</a></li>";
														} else {
															echo "<li><a href='member_center.php'>會員中心</a></li>" . "<li><a href='?logout=true'>Sign out&nbsp[" . $_SESSION["loginMember"] . "]</a></li>";
														} ?></a>
			</ul>
		</header>
					...
					<tr>
						<table width="100%" border="0" cellspacing="0" cellpadding="10">
							<tr valign="top">
								...
								<table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#F0F0F0">
									<tr>
										...
										<th width="20%" bgcolor="#CCCCCC">
											<p align="center">加入時間</p>
										</th>
										<th width="20%" bgcolor="#CCCCCC">
											<p align="center">上次登入</p>
										</th>
									...
									<?php while ($row_RecMember = $RecMember->fetch_assoc()) { ?>
										<tr>
											<td width="10%" align="center" bgcolor="#FFFFFF">
												<p><a href="member_adminupdate.php?id=<?php echo $row_RecMember["m_id"]; ?>">修改</a><br>
													<a href="?action=delete&id=<?php echo $row_RecMember["m_id"]; ?>" onClick="return deletesure();">刪除</a></p>
											</td>
							...
							<tr>
								<td class="tdrline">
									<h1>
										<p class="title">租借資料列表 </p>
									</h1>
									<table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#F0F0F0">
										<tr>
											<th bgcolor="#CCCCCC">&nbsp;</th>
											<th bgcolor="#CCCCCC">
												<p align="center">場地名稱</p>
											</th>
											<th bgcolor="#CCCCCC">
												<p align="center">價錢</p>
											</th>
											<th bgcolor="#CCCCCC">
												<p align="center">場地圖片</p>
											</th>
											<th bgcolor="#CCCCCC">
												<p align="center">場地介紹</p>
											</th>
											<th bgcolor="#CCCCCC">
												<p align="center">人數上限</p>
											</th>
											<th bgcolor="#CCCCCC">
												<p align="center">廚房場地地址</p>
											</th>
										</tr>
										<?php while ($row_product = $product->fetch_assoc()) { ?>
											<tr>
												<td width="5%" align="center" bgcolor="#FFFFFF">
													<p><a href="kit_update" .php?id=<?php echo $row_product["kit_id"]; ?>">修改</a><br>
														<a href="?action=delete&id=<?php echo $row_product["productid"]; ?>" onClick="return deleteproduct();">刪除</a></p>
												</td>
												<td width="15%" align="center" bgcolor="#FFFFFF">
													<p><?php echo $row_product["kit_title"]; ?></p>
												</td>
												<td width="10%" align="center" bgcolor="#FFFFFF">
													<p><?php echo $row_product["kit_price"]; ?></p>
												</td>
												<td width="15%" align="center" bgcolor="#FFFFFF">
													<p><?php if ($row_product["kit_picurl"] == "") { ?>
												...
												<td width="20%" align="center" bgcolor="#FFFFFF">
													<p><?php echo $row_product["kit_dese"]; ?></p>
												</td>
												<td width="10%" align="center" bgcolor="#FFFFFF">
													<p><?php echo $row_product["kit_capacity"]; ?></p>
												</td>
												<td width="20%" align="center" bgcolor="#FFFFFF">
													<p><?php echo $row_product["c_name"] . $row_product["kit_city"] . $row_product["kit_add"]; ?></p>
												</td>
											</tr>
										<?php } ?>
								</td>
						...
						<td>
							...
							<div class="regbox" align="center" style="width:100%">
								...
								<p align="center"><a href="cart_admincreate.php">新增廚房場地資料</a>
									<a href="manage_schedule_0.php">管理廚房場地時間</a>
