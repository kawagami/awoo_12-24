...
<head>
<title>網站會員系統</title>
<link href="index2.css" rel="stylesheet" type="text/css" charset="utf-8">
						  ...
						  <tr valign="top">
							<td class="tdrline"><form action="" method="POST" name="formJoin" id="formJoin" onSubmit="return checkForm();">
							  <div class="dataDiv">
								...
								<p><strong>住　　址</strong>：
								<input name="m_address" type="text" class="normalinput" id="m_address" value="<?php echo $row_RecMember["m_address"];?>" size="50"></p>
								<p><font color="#FF0000">*</font> 表示為必填的欄位</p>
							  </div>
							  <p align="center">
								<input name="m_id" type="hidden" id="m_id" value="<?php echo $row_RecMember["m_id"];?>">
								<input name="action" type="hidden" id="action" value="update">
								<input type="submit" class="button button1" name="Submit2" value="修改資料">
							...
							<div class="regbox" align="left" style="width:60%">
							  <h2 class="heading"><strong>管理員系統</strong></h2>
								<h3><strong><?php echo $row_RecAdmin["m_name"];?></strong> 您好。</h3>
								<p>本次登入的時間為：<br>
