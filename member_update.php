...
if(isset($_POST["action"])&&($_POST["action"]=="update")){	
	...
	$stmt->close();
	//若有修改密碼，則登出回到首頁。
	if(($_POST["m_passwd"]!="")&&($_POST["m_passwd"]==$_POST["m_passwdrecheck"])&&($_POST["m_username"]==$_POST["m_passwd"])){
		unset($_SESSION["loginMember"]);
		unset($_SESSION["memberLevel"]);
					...
					<td class="tdbline"><table width="100%" border="0" cellspacing="0" cellpadding="10">
					  <tr valign="top">
						<td class="tdrline"><form action="" method="POST" name="formJoin" id="formJoin" onSubmit="return checkForm();">
						  <h2 class="title"><strong>修改帳號資料</strong></h2><p><font color="#FF0000">*</font> 表示為必填的欄位</p>
						  <div class="dataDiv">
							<br>
							...
							<input name="m_sex" type="radio" value="男" <?php if($row_RecMember["m_sex"]=="男") echo "checked";?>>不透露
							<font color="#FF0000">*</font></p>
							<p><strong>生　　日</strong>：
						  ...
						  <p align="center">
							...
							<input class="button button1" type="submit" name="Submit2" value="修改資料">
							<input class="button button1" type="reset" name="Submit3" value="重設資料">
							<input class="button button1" type="button" name="Submit" value="回上一頁" onClick="window.history.back();">
						  </p>
						</form></td>
						
						<div class="boxtl"></div><div class="boxtr"></div>
						<div class="regbox" align="center" style="width:60%">
						  <h2 class="heading"><strong>會員系統</strong></h2>
							...
							<p><a href="member_center.php">會員中心</a> | <a href="?logout=true">登出系統</a></p>
						</div>
