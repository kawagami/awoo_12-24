...
(1, '系統管理員', 'admin', '$2y$10$FO70lc.3/vTeE0Vaf7O3Jes.UArylzLnnxfZffTF7410vndnvhScm', '男', NULL, 'admin', NULL, NULL, NULL, NULL, 69, '2019-12-25 14:11:33', '2008-10-20 16:36:15'),
...
(18, 'asd', 'asd123', '$2y$10$hspi3z6gwzQ.xiGTgQIZQOu4O3.Lmk6LzA0hZs6NX5anV4ikCSrU.', '男', '2019-12-19', 'member', 'cdcijl12@sdljf.sdf', NULL, '', '', 22, '2019-12-25 16:38:03', '2019-12-15 14:06:13');
...
(23, 24, 1, 'Dream Kitchen', 1500, 2, NULL),
(26, NULL, 1, 'Dream Kitchen', 1500, 3, NULL),
(27, NULL, 1, 'Dream Kitchen', 1500, 1, NULL),
(28, NULL, 1, 'Dream Kitchen', 1500, 1, NULL),
(29, NULL, 1, 'Dream Kitchen', 1500, 1, NULL);
...
(26, 2000, NULL, NULL, 'dsgf', 'sdfdsf@sdj.sdf', 'rksjgfnkjdsnsnd', '5651651651', 'ATM匯款', 18, '已付款'),
(27, 1500, NULL, NULL, '123', 'sdfg@strgh.adfg', 'ds136151651', '0564654651', 'ATM匯款', 18, ''),
(28, 1500, NULL, NULL, '123', 'sdfg@strgh.adfg', 'ds136151651', '0564654651', 'ATM匯款', 18, '已付款');
...
--
-- 傾印資料表的資料 `tbl_member_rating`
--

INSERT INTO `tbl_member_rating` (`id`, `o_id`, `productid`, `member_id`, `rating`) VALUES
(1, 1, 5, 1, 3);
...
--
ALTER TABLE `orderdetail`
  MODIFY `orderdetailid` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `orders`
--
ALTER TABLE `orders`
  MODIFY `orderid` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
